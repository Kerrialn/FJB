...
@section('content')
    ...
    <li class="tab col m6 s6"><a class="active" href="#grid"><i class="material-icons">view_quilt</i></a></li>
    <li class="tab col m6 s6"><a href="#table"><i class="material-icons">view_list</i></a></li>
  </ul>
